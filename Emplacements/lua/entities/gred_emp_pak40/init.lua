...
ENT.turretBaseModel="models/gredwitch/pak40/pak40_carriage.mdl"
...
function ENT:CreateEmplacement()
	...
	turretBase:SetPos(self:GetPos()-Vector(0,0,-30))
	turretBase:Spawn()
...
function ENT:Initialize()
	self:SetModel("models/gredwitch/pak40/pak40_base.mdl")
...
function ENT:PhysicsSimulate( phys, deltatime )
	...
	self.ShadowParams.pos = self.BasePos + self.turretBase:GetUp()
