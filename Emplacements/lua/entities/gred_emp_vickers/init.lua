...
ENT.turretBaseModel="models/gredwitch/vickers/vickers_tripod.mdl"
...
function ENT:Initialize()
	self:SetModel("models/gredwitch/vickers/vickers_gun.mdl")
	...
	sound.Add( {
		...
		level = 100,
		pitch = {100},
		sound = "gred_emp/vickers/shoot.wav"
	} )
end
